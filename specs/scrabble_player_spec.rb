  ...
  describe "#highest_word_score" do
    ...
    describe "draw_tiles" do
      ...
      it "updates bag to remove tiles drawn" do
        original_length = @my_bag.tiles_remaining.length
        @new_player.draw_tiles(@my_bag)
        new_length = @my_bag.tiles_remaining.length

        new_length.wont_equal original_length
      end
    ...
    describe "#tiles" do
      ...
      it "must return an empty array if draw_tiles has not been called" do
        @new_player.tiles.empty?.must_equal true
      end
    end
